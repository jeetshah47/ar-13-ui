 ...
 * 
 * @param collectionName - The name of the Firestore collection (default: "calendarEvents")
 * @param confirmDelete - Safety flag, set to true to actually delete (default: false)
 * @returns Promise<{ deletedCount: number, success: boolean, error?: string }>
 */
export const deleteAllCalendarEvents = async (
  collectionName: string = "calendarEvents",
